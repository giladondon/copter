; =================================================================================
; Programmer: Mainly Eldad Kapitonlik changed and modified by Gilad Barak
; Name of Procedure: loadPcx
; Date: 9/6/2015
; =============================================================================
; loads given pcx to 320*200 screen
; ==================================================
; INPUT: lds to dx point_Fname
; OUTPUT: loads pcx
; =============================================
; DOES NOT RESTORE REGISTERES (sorry for that)
; =============================================
proc loadPcx
   ...
   ; bx <- Start of Palette
   ; cx <- 256 x 3
   ; in vga we use colors between 0-63. To get it we ;  ; should divide every color by 4
      mov dx, [FileLength]
      sub dx,768d ; 
